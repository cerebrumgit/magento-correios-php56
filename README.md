...
Para atualizar o módulo execute o comando a seguir no terminal do seu servidor
	...
	composer --version && sudo composer self-update && composer clear-cache && composer update -vvv && composer diagnose && composer show -i
...
Ativa o rastreamento automático via CRON
